...
#
#     tools/jl.sh tools/fj8_comparison.jl
#
# Everything it uses is frozen in configs/planning/fj8_evaluation.yaml and
# configs/planning/fj8_seeds.yaml. Nothing here reads a result and changes a
# parameter.
...
open(joinpath(outdir, "six_solver_comparison.md"), "w") do io
    ...
    println(io, "Frozen protocol: `configs/planning/fj8_evaluation.yaml`. ",
