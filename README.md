...
seeded episode reproduces bit for bit on x86-64, where the parity evidence
was produced. On Apple Silicon the platform libm shifts a few derived
read-backs by one ULP (measured: two FJ3 chains at 3 ULP instead of 2;
